...
function updateBatteryStatus(battery) {
    ...
    const roboHashUrl = `https://robohash.org/${batteryLevel}.png`;
    const imageElement = document.getElementById('robohashImage'); // Make sure to have an img element with this ID in your HTML
    imageElement.src = roboHashUrl;
}
